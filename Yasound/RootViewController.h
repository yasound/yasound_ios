...
#define NOTIF_GOTO_YASOUND_ASSOCIATION @"NOTIF_GOTO_YASOUND_ASSOCIATION"
...
#define NOTIF_GOTO_FRIENDS @"NOTIF_GOTO_FRIENDS"
...
#define NOTIF_GOTO_NOTIFICATIONS @"NOTIF_GOTO_NOTIFICATIONS"

...
//	self.graphView = [[S7GraphView alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
	self.graphView = [[S7GraphView alloc] initWithFrame:CGRectMake(0, 0, 320, 416)];
...
- (void)viewDidLoad {
	...
	self.graphView.xValuesColor = [UIColor grayColor];
	self.graphView.yValuesColor = [UIColor grayColor];
	
	self.graphView.gridXColor = [UIColor grayColor];
	self.graphView.gridYColor = [UIColor grayColor];
	
	self.graphView.drawInfo = NO;
	self.graphView.info = @"Load";
	self.graphView.infoColor = [UIColor grayColor];

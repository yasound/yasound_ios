...
enum SECTION_MYRADIO_ENUM
{
  ROW_MYRADIO_MYRADIO,
  SECTION_MYRADIO_NB_ROWS
};

enum SECTION_RADIOS_ENUM
{
  ROW_RADIOS_FRIENDS,
  ROW_RADIOS_FAVORITES,
  ROW_RADIOS_SELECTION,
  ROW_RADIOS_TOP,
  ROW_RADIOS_SEARCH,
  SECTION_RADIOS_NB_ROWS
};

enum SECTION_ME_ENUM
{
  ROW_ME_NOTIFS,
  ROW_ME_STATS,
  ROW_ME_PROGRAMMING,
...
enum SECTION_MISC_ENUM
{
  ROW_MISC_LEGAL,
  ROW_MISC_LOGOUT,
  SECTION_MISC_NB_ROWS
};
